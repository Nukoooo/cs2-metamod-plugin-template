...
bool Plugin::Load(PluginId id, ISmmAPI* ismm, char* error, size_t maxlen, bool late)
{
    ...
    SH_ADD_HOOK_MEMFUNC(IServerGameClients, ClientActive, interfaces::gameclients, this, &Plugin::Hook_ClientActive,
                        true);
    SH_ADD_HOOK_MEMFUNC(IServerGameClients, ClientDisconnect, interfaces::gameclients, this,
                        &Plugin::Hook_ClientDisconnect, true);
    SH_ADD_HOOK_MEMFUNC(IServerGameClients, ClientPutInServer, interfaces::gameclients, this,
                        &Plugin::Hook_ClientPutInServer, true);
    SH_ADD_HOOK_MEMFUNC(IServerGameClients, ClientSettingsChanged, interfaces::gameclients, this,
                        &Plugin::Hook_ClientSettingsChanged, false);
    SH_ADD_HOOK_MEMFUNC(IServerGameClients, OnClientConnected, interfaces::gameclients, this,
                        &Plugin::Hook_OnClientConnected, false);
    SH_ADD_HOOK_MEMFUNC(IServerGameClients, ClientConnect, interfaces::gameclients, this, &Plugin::Hook_ClientConnect,
                        false);
    SH_ADD_HOOK_MEMFUNC(IServerGameClients, ClientCommand, interfaces::gameclients, this, &Plugin::Hook_ClientCommand,
                        false);
...
void Plugin::Hook_OnClientConnected(CPlayerSlot slot, const char* pszName, uint64 xuid, const char* pszNetworkID,
                                    const char* pszAddress, bool bFakePlayer)
{
    // META_CONPRINTF("Hook_OnClientConnected(%d, \"%s\", %d, \"%s\", \"%s\", %d)\n", slot, pszName, xuid, pszNetworkID, pszAddress, bFakePlayer);
}

bool Plugin::Hook_ClientConnect(CPlayerSlot slot, const char* pszName, uint64 xuid, const char* pszNetworkID, bool unk1,
...
void
Plugin::Hook_ClientDisconnect(CPlayerSlot slot, ENetworkDisconnectionReason reason, const char* pszName, uint64 xuid,
...
void
Plugin::OnLevelInit(char const* pMapName, char const* pMapEntities, char const* pOldLevel, char const* pLandmarkName,
