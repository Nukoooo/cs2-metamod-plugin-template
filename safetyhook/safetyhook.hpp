...
public:
    ...
    [[nodiscard]] static tl::expected<InlineHook, Error> create(void* target, void* destination);
    ...
    /// @note This will use the default global Allocator.
    /// @note If you don't care about error handling, use the easy API (safetyhook::create_inline).
    [[nodiscard]] static tl::expected<InlineHook, Error> create(FnPtr auto target, FnPtr auto destination) {
...
public:
    ...
    [[nodiscard]] static tl::expected<MidHook, Error> create(void* target, MidHookFn destination_fn);
    ...
    /// @note This will use the default global Allocator.
    /// @note If you don't care about error handling, use the easy API (safetyhook::create_mid).
    [[nodiscard]] static tl::expected<MidHook, Error> create(FnPtr auto target, MidHookFn destination_fn) {
